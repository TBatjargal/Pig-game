...
//  Pig game
//
//  Created by Tsolmon Batjargal on 10/23/24.
//
            ...
            ZStack {
                ...
                VStack {
                    ...
                    VStack(alignment: .leading) {
                        Text("In the game of Pig, players take individual turns. Each turn, a player repeatedly rolls a single dice until either a pig is rolled or the player deicded to \"hold\".")
                            .padding()
                        Text("If a player rolls a pig, they score nothing and it is the next player's turn.")
                            .padding()
                        Text("If the player rolls any other number, it is added to their turn total, and the player's continues.")
                            .padding()
